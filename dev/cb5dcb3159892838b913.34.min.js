...
var audittaskexport = function (_DataBase) {
  _inherits(audittaskexport, _DataBase);

  function audittaskexport() {
    _classCallCheck(this, audittaskexport);

    return _possibleConstructorReturn(this, (audittaskexport.__proto__ || Object.getPrototypeOf(audittaskexport)).apply(this, arguments));
  }

  _createClass(audittaskexport, [{
    key: 'complete',
    value: function complete() {
      var _this2 = this;
      ...
      this.resize();
      this.model.tableconfig.tablewidth = ES.selctorDoc('.audittaskexport').box().clientWidth - 240;
      this.dom.find('.create').on('click', function () {
        _this2.app.changePage('createaudittask1', { type: 'new' });
      });
      this.loadlist('group');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return this.api.audit_task_search(this.model.apiData);
    ...
    key: 'listaction',
    value: function listaction(value) {
      switch (value.classname) {
        case 'exportdata':
          if (value.id.split(',')[1] > 0) {
            ...
            var url = this.app.domain1 + 'v1/audit/task/statistics/export?param=' + encodeURI(JSON.stringify(json));
        ...
        case 'exportres':
          if (value.id.split(',')[1] > 0) {
            ...
            var _url = this.app.domain1 + '/v1/audit/task/series/result/export?param=' + encodeURIComponent(JSON.stringify(_json));
            Tool.downfile(_url, this.app);
          } else {
            this.app.alert.show({
              title: ' ',
              msg: '无已审核序列，不支持导出。',
      ...
      if (value) {
        switch (value.name) {
          case 'projectIdList':
            ...
            this.audit_project_name_search(value.data.data ? value.data.data.trim() : "");
            break;
          case 'taskIdList':
    ...
    key: 'audit_project_name_search',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(auditProjectName) {
        var json1, _ref3, data, temparr;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return this.api.audit_project_name_search(json1);
      ...
      function audit_project_name_search(_x2) {
        return _ref2.apply(this, arguments);
      }

      return audit_project_name_search;
    }()
  }, {
    key: 'task_like_query',
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(taskNameKey) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return this.api.task_like_query(json1);
              ...
              case 3:
                ...
                temparr = data.list ? data.list.map(function (item) {
                  return {
                    idx: item.taskId,
                    val: item.taskName
                  };
      ...
      function task_like_query(_x3) {
        return _ref4.apply(this, arguments);
      }

      return task_like_query;
    }()
    ...
    value: function resize() {
      ...
      ES.selctorDoc('.audittaskexport').css({ 'height': ch, 'width': cw });
      ES.selctorDoc('.scrolltable').css({ 'height': ch - 200 });
    }
  }]);

  return audittaskexport;
}(DataBase);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./audittaskexport.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./audittaskexport.less");
...
var api = {
  audit_task_search: function audit_task_search(value) {
    return this.HttpRequest.POST(urlDict.audit_task_search, value);
  },
  audit_task_start: function audit_task_start(value) {
    return this.HttpRequest.POST(urlDict.audit_task_start, value);
  },
  audit_task_series_needaudit_count: function audit_task_series_needaudit_count(value) {
    return this.HttpRequest.POST(urlDict.audit_task_series_needaudit_count, value);
  },
  result_export: function result_export(value) {
    return this.HttpRequest.POST(urlDict.result_export, value);
  },
  project_search: function project_search(value) {
    return this.HttpRequest.POST(urlDict.project_search, value);
  },
  audit_project_name_search: function audit_project_name_search(value) {
...
module.exports = "<div class=audittaskexport> <div class=scroll> <div class=filterarea> </div> <div class=btnarea> <a class=\"fillBtn searchbtn\">查询</a> </div> <div class=tablearea> </div> </div> </div> ";
...
var audittaskexport = function (_Interstellar$modelBa) {
    _inherits(audittaskexport, _Interstellar$modelBa);

    function audittaskexport(app) {
        _classCallCheck(this, audittaskexport);

        var _this = _possibleConstructorReturn(this, (audittaskexport.__proto__ || Object.getPrototypeOf(audittaskexport)).call(this, app));

        _this.condition = [[{ "type": "dobuledropdown", "name": "taskIdList", "showname": "选择审核任务名称", "datatype": "obj", "data": [], "key": "taskIdList", "out": true, "input": true }], [{ "type": "dobuledropdown", "name": "projectIdList", "showname": "选择审核项目名称", "datatype": "obj", "data": [], "key": "projectIdList", "out": true, "input": true }]];
        _this.apiData = { page: 1, pageSize: 10, isReleased: false };
        _this.tableconfig = {
            icon: {
                "id": { name: '<span>审核任务ID</span>', type: 'text', code: 'checkid', w: '15%', ww: '15%', n: "40" },
                "name": { name: '<span>审核任务名称</span>', type: 'text', code: 'pid', w: '20%', ww: '20%' },
                "auditChoose": { name: '<span>审核集</span>', type: 'text', code: 'pid', w: '15%', ww: '15%' },
                "projectName": { name: '<span>所属审核项目名称</span>', type: 'text', code: 'pname', w: '20%', ww: '20%' },
                "status": { name: '<span>状态</span>', type: 'text', code: 'psex', w: '10%', ww: '10%' },
                "seriesTotalNum": { name: '<span>序列总数</span>', type: 'text', code: 'age', w: '10%', ww: '10%' },
                "seriesAuditNum": { name: '<span>已审核数量</span>', type: 'text', code: 'age', w: '10%', ww: '10%' }
            },
            actionulwidth: 200,
            type: 'center',
            actionicon: {
        ...
        _this.listicon = {
            action: { //待发布
                config: { dis: 'inline', link: 'noLink', content: [{ text: '导出审核结果', key: 'exportres' }, { text: '导出审核统计数据', key: 'exportdata' }] }
            }
        };
        return _this;
    }
...
// module
exports.push([module.i, ".audittaskexport {\n  margin: 20px;\n  background: #fff;\n  height: 100%;\n  overflow: hidden;\n}\n.audittaskexport .filterarea {\n  margin: 20px;\n  width: 900px;\n}\n.audittaskexport .filterarea .content {\n  margin-right: 20px;\n}\n.audittaskexport .filterarea .content .xlk {\n  width: 170px;\n  height: 35px;\n  line-height: 35px;\n}\n.audittaskexport .filterarea .content .xlk .nowname {\n  width: 94%;\n}\n.audittaskexport .filterarea .content .duoxuanxlk {\n  width: 170px;\n  height: 35px;\n  line-height: 35px;\n}\n.audittaskexport .filterarea .content .inputtext {\n  width: 160px;\n  padding-left: 10px;\n  height: 35px;\n  line-height: 35px;\n}\n.audittaskexport .filterarea .inspectTime {\n  position: relative;\n}\n.audittaskexport .filterarea .inspectTime .chooseData > div {\n  display: inline-block;\n}\n.audittaskexport .filterarea .inspectTime .chooseData .showData {\n  width: 170px;\n  height: 35px;\n  line-height: 35px;\n  border-radius: 4px;\n}\n.audittaskexport .btnarea {\n  position: absolute;\n  top: 40px;\n  right: 20px;\n}\n.audittaskexport .btnarea .biaozhubtn {\n  margin-right: 20px;\n  height: 35px;\n  line-height: 35px;\n  padding: 0 20px;\n  background: #4c9fa9;\n  color: #fff;\n}\n.audittaskexport .tablearea .actionul {\n  width: 140px!important;\n  left: -55px !important;\n}\n.audittaskexport .tablearea .actiontable .ul {\n  overflow: unset;\n}\n.audittaskexport .tablearea .list {\n  min-height: 350px;\n}\n", ""]);
...
//# sourceMappingURL=cb5dcb3159892838b913.34.min.js.map