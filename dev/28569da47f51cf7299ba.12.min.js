    ...
    _createClass(markaudit, [{
        ...
        value: function baseApi() {
            ...
            this.api.task_read({
                ...
                _this2.api.annoitem_task_read({
                    taskId: _this2.app.parpam['taskId']
                }).done(function (res) {

                    _this2.model.setData('projectInfo', res.data);
                });
            });
        }
        ...
        value: function btnEvent() {
            ...
            this.dom.find('.back-icon').on('click', function () {
                ...
                //     window.location.href = 'http://' + window.location.host + '/#!/ytjtaskdetail/' + this.app.parpam['taskId']
                //     window.location.reload()
        ...
        value: function submitSeries() {
            ...
            this.api.series_audit_submit({
                ...
                if (value.code != 0) {
                    _this6.app.alert.show({
                        title: ' ',
                        msg: value.msg
                    });
                } else {
                    if (_this6.model.doneNum == -1) {
                        window.location.href = 'http://' + window.location.host + '/#!/personalaccount';
                        window.location.reload();
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./markaudit.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./markaudit.less");
...
module.exports = "<div class=markaudit> <ul class=mark-header> <li class=\"back-icon fl\"> <span><span class=lefta><i class=\"iconfont icon-icon-test3\" style=font-size:12px></i></span>返回</span> </li> <li class=\"task-name fl\"> <span>|</span> <span></span> </li> <li class=\"discard_info fr\" style=margin-right:10px></li> <li class=\"cotrol-btn fr\"> <div class=\"btn btn-submit\">提交审核</div> <div class=\"btn btn-submit1\">上一个序列</div> <div class=\"btn btn-submit2\">下一个序列</div> </li> </ul> <div class=mark-menu></div> <div class=mark-content> </div> </div>";
...
//# sourceMappingURL=28569da47f51cf7299ba.12.min.js.map