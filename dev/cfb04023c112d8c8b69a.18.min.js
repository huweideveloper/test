...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./drapCanvasAud.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./drapCanvasAud.less");
    ...
    _createClass(CanvasBase, [{
        ...
        value: function baseApi() {
            ...
            this.api.annoitem_task_read({
                ...
                _this2.api.task_read({
                    id: _this2.app.parpam['taskId']
                }).done(function (res) {
                    _this2.dom.find('.task-name span').eq(1).html(res.data.name);
                    _this2.model.taskInfo = res.data;
        ...
        value: function annotationIteminit() {
            ...
            if (this.app.parpam['type'] == 'check_viewer' || this.app.parpam['type'] == 'check_viewer_taskdetail' || this.app.parpam['type'] == 'check_viewer_taskdetail_view') {
                ...
                console.log(this.model.taskInfo.studyAnno, this.model.taskInfo);
                if (this.model.taskInfo.studyAnno) {
                    this.api.task_study_result_read({
                        userId: taskData[2],
        ...
        value: function btnEvent() {
            ...
            this.dom.find('.back-icon').on('click', function () {
                if (_this6.app.parpam['type'] == 'check_viewer_taskdetail') {
                    // window.location.href = 'http://' + window.location.host + '/#!/taskdetail/' + this.app.parpam['taskId'] + '/editor'
                    // window.location.reload()
                    _this6.app.changePage('taskdetail', { taskId: _this6.app.parpam['taskId'], type: 'editor' });
                    return;
                }
                if (_this6.app.parpam['type'] == 'check_viewer_taskdetail_view') {
                    // window.location.href = 'http://' + window.location.host + '/#!/taskdetail/' + this.app.parpam['taskId'] + '/view'
                    // window.location.reload()
                    _this6.app.changePage('taskdetail', { taskId: _this6.app.parpam['taskId'], type: 'view' });
                    return;
                }
                // window.location.href = 'http://' + window.location.host + '/#!/viewaudittask/' + this.app.parpam['taskId']
                // window.location.reload()
                _this6.app.changePage('viewaudittask', { id: _this6.app.parpam['taskId'] });
            });
            var that = this;
            if (this.app.parpam['type'].lastIndexOf('viewer_all') == -1) {
                ...
                this.dom.find('.cotrol-btn .btn-submit1').on('click', function () {
                    //console.log('aaaa')
                    if (ti[1] * 1 > 0) {
                        var nowtaksInfod = ti[0] + '_' + (ti[1] - 1);
                        window.location.href = 'http://' + window.location.host + '/#!/drapCanvasAud/' + _this6.app.parpam['taskId'] + '/' + nowtaksInfod + '/check_viewer_all';
                        window.location.reload();
                    } else {
                ...
                this.dom.find('.cotrol-btn .btn-submit2').on('click', function () {
                    if (ti[1] * 1 < ti[0] - 1) {
                        var nowtaksInfod = ti[0] + '_' + (ti[1] * 1 + 1);
                        window.location.href = 'http://' + window.location.host + '/#!/drapCanvasAud/' + _this6.app.parpam['taskId'] + '/' + nowtaksInfod + '/check_viewer_all';
                        window.location.reload();
                    } else {
...
//# sourceMappingURL=cfb04023c112d8c8b69a.18.min.js.map