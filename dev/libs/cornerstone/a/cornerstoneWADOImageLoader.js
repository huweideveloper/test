...
function populatePaletteColorLut(dataSet, imagePixelModule) {
  ...
  // The first Palette Color Lookup Table Descriptor value is the number of entries in the lookup table_group.
  // When the number of table_group entries is equal to 2ˆ16 then this value shall be 0.
...
function getEncapsulatedImageFrame(dataSet, frameIndex) {
  ...
  // Empty basic offset table_group
