    ...
    _createClass(markaudit, [{
        ...
        value: function baseApi() {
            ...
            if (this.app.parpam['type'] == 'check_viewer_all') {
                ...
                this.api.series_result_next({
                    ...
                    _this2.tempRes.remark = value.data.remark;
        ...
        value: function btnEvent() {
            ...
            this.dom.find('.back-icon').on('click', function () {
                window.location.href = 'http://' + window.location.host + '/#!/viewauditres/' + _this4.app.parpam['projectId'];
            ...
            if (this.app.parpam['type'].lastIndexOf('viewer_all') == -1) {
                ...
                this.dom.find('.cotrol-btn .btn-submit1').on('click', function () {
                    ...
                    if (ti[1] * 1 > 0) {
                        ...
                        window.location.href = 'http://' + window.location.host + '/#!/markauditprojectview/' + _this4.app.parpam['projectId'] + '/' + nowtaksInfod + '/check_viewer_all';
                        window.location.reload();
                    } else {
                        _this4.alerError('没有上一个序列了！');
                    }
                });
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./markauditprojectview.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./markauditprojectview.less");
...
//# sourceMappingURL=f8c5b36ade36ff10a74d.11.min.js.map