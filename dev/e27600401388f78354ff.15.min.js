...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./drapCanvasPro.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./drapCanvasPro.less");
...
var api = {
  ...
  //项目读取
  annoitem_project_read: function annoitem_project_read(value) {
    var st = api.app.tokentime();
    if (!st) {
      delete value.token;
    }
  ...
  //任务读取
  project_read: function project_read(value) {
    var st = api.app.tokentime();
    if (!st) {
      delete value.token;
    }
...
var DrapCanvasPro = function (_MarkBase) {
    _inherits(DrapCanvasPro, _MarkBase);

    function DrapCanvasPro(app, api, dom, model) {
        _classCallCheck(this, DrapCanvasPro);

        return _possibleConstructorReturn(this, (DrapCanvasPro.__proto__ || Object.getPrototypeOf(DrapCanvasPro)).call(this, app, api, dom, model));
    }
    //接口调用，获取信息


    _createClass(DrapCanvasPro, [{
        key: 'baseApi',
        value: function baseApi() {
            ...
            if (this.app.parpam['type'] == 'check_viewer_all') {
                var data = JSON.parse(decodeURIComponent(this.app.parpam['projectInfo'].split('_')[2]));
                this.api.series_result_next({
                    ...
                    _this2.api.annoitem_project_read({
                        sarId: value.data.sarId
                    }).done(function (value) {
                        console.log(value, '12312312312');
        ...
        value: function result_get_fromback() {
            ...
            var _loop = function _loop(i) {
                _this3.api.series_result_read({
                    ...
                    _this3.model.seriesResult[lists[i].seriesAnnotationResultId] = res;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 11:
                                ...
                                console.log(this.model._orginImgSizes, 'sdasds');
        ...
        value: function annotationIteminit() {
            ...
            var xu1 = 0;
            projectInfo.annotationItemList.forEach(function (item) {
            ...
            var _loop2 = function _loop2(i) {
                ...
                if (teampData.length != 0) {
                    nidusinfo[projectInfo.imageAnnotationList[i].type] = _this4.translateData(projectInfo.imageAnnotationList[i].annotationItemList);
                }
            };
            ...
            console.log(nidusinfo, '少时诵诗书所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所所');
            ...
            if (this.app.parpam['type'] == 'check_viewer') {
                var taskData = this.app.parpam['projectInfo'].split('_');
                /*let temp = {
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                ...
                                console.log(document.getElementById("drapCanvasPro"));
        ...
        value: function btnEvent() {
            ...
            this.dom.find('.back-icon').on('click', function () {
                window.location.href = 'http://' + window.location.host + '/#!/viewauditres/' + _this6.app.parpam['projectId'];
            ...
            if (this.app.parpam['type'].lastIndexOf('viewer_all') == -1) {
                ...
                var ti = this.app.parpam['projectInfo'].split('_');
                this.dom.find('.cotrol-btn .btn-submit1').on('click', function () {
                    console.log('aaaa');
                    if (ti[1] * 1 > 0) {
                        var nowtaksInfod = ti[0] + '_' + (ti[1] - 1) + '_' + ti[2];
                        window.location.href = 'http://' + window.location.host + '/#!/drapCanvasPro/' + _this6.app.parpam['projectId'] + '/' + nowtaksInfod + '/check_viewer_all';
                        window.location.reload();
                    } else {
                        _this6.alerError('没有上一个序列了！');
                    }
                });
                this.dom.find('.cotrol-btn .btn-submit2').on('click', function () {
                    if (ti[1] * 1 < ti[0] - 1) {
                        var nowtaksInfod = ti[0] + '_' + (ti[1] * 1 + 1) + '_' + ti[2];
                        window.location.href = 'http://' + window.location.host + '/#!/drapCanvasPro/' + _this6.app.parpam['projectId'] + '/' + nowtaksInfod + '/check_viewer_all';
                        window.location.reload();
                    } else {
                        _this6.dom.find('.back-icon').click();
                    }
                });
            }
        }
...
//# sourceMappingURL=e27600401388f78354ff.15.min.js.map