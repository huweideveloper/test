...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./markview.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./markview.less");
...
var mark = function (_MarkBase) {
    _inherits(mark, _MarkBase);

    function mark(app, api, dom, model) {
        _classCallCheck(this, mark);

        return _possibleConstructorReturn(this, (mark.__proto__ || Object.getPrototypeOf(mark)).call(this, app, api, dom, model));
    }
    ...
    _createClass(mark, [{
        ...
        value: function annotationIteminit() {
            ...
            console.log(this.app.parpam['sid']);
            console.log(Base64.decode(this.app.parpam['sid']));
            this.app.parpam['sid'] = Base64.decode(this.app.parpam['sid']);
            ...
            if (this.app.parpam['type'] != 'viewer_all') {
                ...
                this.api.task_user_series_search(this.model.frompage).done(function (value) {
                    if (value.data.list.length != 0) {
                        _this3.series_get(value.data.list[0].serialNumber);
                    } else {
                        //return
                        window.location.href = 'http://' + window.location.host + '/#!/ytjtaskdetail/' + _this3.app.parpam['taskId'] + '/' + _this3.app.parpam['taskType'];
        ...
        /*creatOnePoint(imgs, data) {
            ...
            //console.log(this.model.getImages(imgs.images, this.model.seriesInfo.info.wwc.flag, total))
            //return
            let newdata = {
        ...
        value: function result_get_fromback() {
            ...
            var _loop = function _loop(i) {
                _this5.api.series_result_read({
                    ...
                    _this5.model.seriesResult[lists[i].seriesAnnotationResultId] = res;
        ...
        value: function btnEvent() {
            ...
            this.dom.find('.back-icon').on('click', function () {
                if (_this7.app.parpam['type'] != "viewer") {
                    // window.location.href = 'http://' + window.location.host + '/#!/ytjtaskdetail/' + this.app.parpam['taskId'] + '/' + this.app.parpam['taskType']
                    // window.location.reload()
                    _this7.app.changePage('ytjtaskdetail', {
                        taskid: _this7.app.parpam['taskId'],
                        taskType: _this7.app.parpam['taskType']
                    });
                    return;
                } else {
                    // window.location.href = 'http://' + window.location.host + '/#!/taskdetail/' + this.app.parpam['taskId'] + '/' + this.app.parpam['rid']
                    // window.location.reload()
                    _this7.app.changePage('taskdetail', {
                        taskId: _this7.app.parpam['taskId'],
                        type: _this7.app.parpam['rid']
                    });
                    return;
                }
            });
            ...
            if (this.app.parpam.type == 'viewer_all') {
                this.dom.find('.cotrol-btn .btn-submit').on('click', function () {
                    // window.location.href = 'http://' + window.location.host + '/#!/markview/' + this.app.parpam['taskId'] + '/' + this.app.parpam['projectId'] + '/' + this.app.parpam['type'] + '/' + this.app.parpam['uid'] + '/' + (this.app.parpam['sid'] * 1 + 1) + '//' + this.app.parpam['taskType']
                    // window.location.reload()
                    _this7.app.changePage('markview', {
                        taskId: _this7.app.parpam['taskId'],
                        projectId: _this7.app.parpam['projectId'],
                        type: _this7.app.parpam['type'],
                        uid: _this7.app.parpam['uid'],
                        sid: _this7.app.parpam['sid'] * 1 + 1,
                        taskType: _this7.app.parpam['taskType']
                    });
                });
                this.dom.find('.cotrol-btn .btn-submit1').on('click', function () {
                    if (_this7.app.parpam['sid'] * 1 - 1 == 0) {
                        _this7.alerError('没有上一个序列了！');
                        return;
                    }
                    _this7.app.changePage('markview', {
                        taskId: _this7.app.parpam['taskId'],
            ...
            if (this.app.parpam.type == 'editor') {
                this.dom.find('.cotrol-btn .btn-submit2').on('click', function () {
        ...
        value: function series_submit() {
            ...
            this.api.series_result_submit({
                ...
                if (_this8.model.doneNum > _this8.model.cachelist.length) {
                    _this8.submitFinish();
                    return;
                }
                _this8.series_get();
...
module.exports = "<div class=markview> <ul class=mark-header> <li class=\"back-icon fl\"> <span><span class=lefta><i class=\"iconfont icon-icon-test3\" style=font-size:12px></i></span>返回</span> </li> <li class=\"task-name fl\"> <span>|</span> <span>Cassiel0705标注4</span> </li> <li class=\"discard_info fr\" style=margin-right:10px></li> <li class=\"cotrol-btn fr\"> <div class=\"btn btn-submit2\">提交</div> <div class=\"btn btn-submit1\">上一个序列</div> <div class=\"btn btn-submit\">下一个序列</div> </li> </ul> <div class=mark-menu></div> <div class=mark-content> </div> </div>";
...
var markmodel = function (_MarkModel) {
    ...
    _createClass(markmodel, [{
        ...
        value: function changeItemDataToBackend(id, value) {
            ...
            for (var i in value) {
                var data = value[i].result.split(',').filter(function (item) {
                    return item;
                }).toString();
...
//# sourceMappingURL=f04e04f0dd22af1c46e1.8.min.js.map