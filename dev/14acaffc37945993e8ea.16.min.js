...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./drapCanvasCheck.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./drapCanvasCheck.less");
...
var markpreview = function (_MarkBase) {
    ...
    function markpreview(app, api, dom, model) {
        ...
        var _this = _possibleConstructorReturn(this, (markpreview.__proto__ || Object.getPrototypeOf(markpreview)).call(this, app, api, dom, model));
    ...
    _createClass(markpreview, [{
        ...
        value: function apiload() {
            ...
            this.api.task_read({ id: this.app.parpam['taskId'] }).done(function (value) {
        ...
        value: function annotationIteminit() {
            ...
            if (this.app.parpam['type'] != 'viewer_all') {
                ...
                this.model.frompage = { taskId: this.app.parpam['taskId'], userId: this.app.parpam['uid'], page: this.app.parpam['sid'], pageSize: 1 };
                this.api.task_user_series_search(this.model.frompage).done(function (value) {
                    if (value.data.list.length != 0) {
                        ...
                        //return
                        window.location.href = 'http://' + window.location.host + '/#!/ytjtaskdetail/' + _this3.app.parpam['taskId'];
        ...
        value: function start_series() {
            ...
            for (var i = 0; i < data.seriesInstanceUids.length; i++) {
                ...
                var aa = JSON.parse(JSON.stringify(data.seriesInstanceUids[i]));
                        ...
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                return this.api.sys_transfer({
                                    ...
                                    params: JSON.stringify({ "seriesInstanceUID": seriesInstanceUid })
            ...
            this.api.series_result_search({
                ...
                if (value.data.list.length != 0) {
                    ...
                    for (var i = 0; i < value.data.list.length; i++) {
                        ...
                        seriesInstanceUids.push({ seriesAnnotationResultId: data.id, seriesInstanceUid: data.seriesInstanceUid });
                    }
        ...
        value: function cornerstoneContorlOther() {
            ...
            this.cornerstoneContorl.event._addEvent('ctcornerstone.addNode', function (value) {
                console.log(value, _this5.model.seriesInfo[value.sId]);
                var postData = {};
                postData.seriesAnnotationResultId = _this5.model.seriesInfo[value.sId].sarId; // that.model.seriesResult.data.id //.info.data.seriesInstanceUID
                postData.imageAnnotationId = value.toolType.imageAnnotationId;
                postData.imageAnnotationToolId = value.toolType.id;
                postData.result = _this5.model.makeJsonToBackend(value.path);
                //console.log(postData.result)
                _this5.api.image_result_create(postData).done(function (res) {
                    _this5.app.loading.hide();
                    value.backId = res.data.id;
                    _this5.cornerstoneContorl.updataSequencelist(value);
                });
            });
            ...
            this.cornerstoneContorl.event._addEvent('ctcornerstone.editNode', function (value) {
                ...
                _this5.api.image_result_update(postData).done(function (res) {
                    _this5.app.loading.hide();
                });
            });
            this.cornerstoneContorl.event._addEvent('ctcornerstone.deleteNode', function (value) {
                _this5.app.loading.show();
                _this5.api.image_result_delete({
                    id: value.backId
                }).done(function (res) {
                    _this5.app.loading.hide();
                });
            ...
            var _loop = function _loop(i) {
                _this6.api.series_result_read({
                    ...
                    if (res.data.discardCode) {
                        ...
                        _this6.dom.find('.discard_info').html('<span>当前序列被标为废片，原因：' + str + '</span>');
                    }
        ...
        value: function btnEvent() {
            ...
            this.dom.find('.back-icon').on('click', function () {
                if (_this7.app.parpam['type'] != "viewer") {
                    ...
                    _this7.app.changePage('ytjtaskdetail', { taskid: _this7.app.parpam['taskId'], taskType: _this7.app.parpam['taskType'] });
                    return;
                } else {
                    // window.location.href = 'http://' + window.location.host + '/#!/taskdetail/' + this.app.parpam['taskId'] + '/' + this.app.parpam['rid']
                    // window.location.reload()
                    _this7.app.changePage('taskdetail', { taskId: _this7.app.parpam['taskId'], type: _this7.app.parpam['rid'] });
                    return;
                }
            });
            var that = this;
            if (this.app.parpam['type'] == 'viewer_all') {
                this.dom.find('.cotrol-btn .btn-submit').on('click', function () {
                    // window.location.href = 'http://' + window.location.host + '/#!/drapCanvasCheck/' + this.app.parpam['taskId'] + '/' + this.app.parpam['projectId'] + '/' + this.app.parpam['type'] + '/' + this.app.parpam['uid'] + '/' + (this.app.parpam['sid'] * 1 + 1)
                    // window.location.reload()
                    _this7.app.changePage('drapCanvasCheck', { taskId: _this7.app.parpam['taskId'], projectId: _this7.app.parpam['projectId'], type: _this7.app.parpam['type'], uid: _this7.app.parpam['uid'], sid: _this7.app.parpam['sid'] * 1 + 1, taskType: _this7.app.parpam['taskType'] });
                });
...
module.exports = "<div class=drapCheck> <ul class=mark-header> <li class=\"back-icon fl\"> <span><span class=lefta><i class=\"iconfont icon-icon-test3\" style=font-size:12px></i></span><span class=infojian>医生主页</span></span> </li> <li class=\"task-name fl\"> <span>|</span> <span>Cassiel0705标注4</span> </li> <li class=\"cotrol-btn fr\"> <div class=\"btn btn-submit1\">上一个序列</div> <div class=\"btn btn-submit\">下一个序列</div> </li> <li class=\"discard_info fr\" style=margin-right:10px></li> </ul> <div class=mark-menu></div> <div class=mark-content> </div> </div>";
...
//# sourceMappingURL=14acaffc37945993e8ea.16.min.js.map