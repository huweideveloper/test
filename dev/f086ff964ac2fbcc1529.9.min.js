...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./markpreview.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./markpreview.less");
...
var markpreview = function (_MarkBase) {
    _inherits(markpreview, _MarkBase);

    function markpreview(app, api, dom, model) {
        _classCallCheck(this, markpreview);

        return _possibleConstructorReturn(this, (markpreview.__proto__ || Object.getPrototypeOf(markpreview)).call(this, app, api, dom, model));
    }
    //初始化加载接口


    _createClass(markpreview, [{
        key: 'apiload',
        ...
        value: function discaseToDone(value, dom) {
            ...
            this.alertSubmit.show({
                ...
                closeSure: function closeSure() {
                    window.location.href = 'http://' + window.location.host + '/#!/createprothree/' + this.app.parpam['taskId'] + '/' + this.app.parpam['projectId'];
        ...
        value: function btnEvent() {
            ...
            this.dom.find('.back-icon').on('click', function () {
                window.location.href = 'http://' + window.location.host + '/#!/' + page + '/edit' + '/' + _this4.app.parpam['projectId'] + '/' + _this4.app.parpam['status'];
                window.location.reload();
            });
...
//# sourceMappingURL=f086ff964ac2fbcc1529.9.min.js.map