...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./drapCanvasView.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./drapCanvasView.less");
...
var api = (_api = {
    ...
    //获取一个序列号
    project_series_next: function project_series_next(value) {
        var st = api.app.tokentime();
        if (!st) {
            delete value.token;
        }
...
}, _defineProperty(_api, 'series_origin_detail', function series_origin_detail(value) {
    var st = api.app.tokentime();
    if (!st) {
        delete value.token;
    }
    ...
    return deferred;
}), _defineProperty(_api, 'task_read', function task_read(value) {
    var st = api.app.tokentime();
    if (!st) {
        delete value.token;
    }
    ...
    return deferred;
}), _defineProperty(_api, 'series_read', function series_read(value) {
    var st = api.app.tokentime();
    if (!st) {
        delete value.token;
    }
    ...
    return deferred;
}), _defineProperty(_api, 'image_query', function image_query(value) {
    var st = api.app.tokentime();
    if (!st) {
        delete value.token;
    }
    ...
    return deferred;
}), _defineProperty(_api, 'series_cache', function series_cache(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'series_get', function series_get(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'series_result_create', function series_result_create(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'series_result_read', function series_result_read(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'series_result_submit', function series_result_submit(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'series_result_query', function series_result_query(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'series_result_item_edit', function series_result_item_edit(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'image_result_create', function image_result_create(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'image_result_update', function image_result_update(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'image_result_delete', function image_result_delete(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'image_result_item_edit', function image_result_item_edit(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'series_discard', function series_discard(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'image_process_create', function image_process_create(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'image_process_batch_read', function image_process_batch_read(value) {
    var deferred = ES.Deferred();
    ES.ajax({
    ...
    return deferred;
}), _defineProperty(_api, 'image_process_item_edit', function image_process_item_edit(value) {
    var deferred = ES.Deferred();
    ES.ajax({
...
var CanvasBase = function (_MarkBase) {
  ...
  _createClass(CanvasBase, [{
    ...
    value: function apiload() {
      ...
      this.api.project_basic_read({ id: this.app.parpam['projectId'] }).done(function (value) {
        _this2.dom.find('.task-name span').eq(1).html(value.data.name);
        _this2.dom.find('.infojian').html('返回项目');
    ...
    value: function series_get() {
      ...
      this.api.project_series_next({ projectId: this.app.parpam['projectId'] }).done(function (value) {
        _this3.app.loading.hide();

        var serLength = value.data.seriesList.length;
        var seriesInstanceUids = [];
        for (var i = 0; i < serLength; i++) {
          seriesInstanceUids.push({ seriesAnnotationResultId: 30 + i, seriesInstanceUid: value.data.seriesList[i] });
        }
        var temp = { studyInstanceUid: value.data.studyInstanceUid, seriesInstanceUids: seriesInstanceUids };
        ...
        var lists = _this3.model.series_result_id.seriesInstanceUids;
        for (var _i = 0; _i < lists.length; _i++) {
          _this3.model.seriesResult[lists[_i].seriesAnnotationResultId] = {
            data: {
              "auditId": null,
              "annotationItemResultList": [],
              "seriesInstanceUid": lists[_i].seriesInstanceUid,
              "submitTime": null,
              "imageAnnotationResultList": [],
              "id": lists[_i].seriesAnnotationResultId,
              "algVersionId": null,
              "userId": "",
              "projectId": _this3.app.parpam['projectId'],
              "taskId": _this3.app.parpam['taskId'],
              "status": 1
            }
          };
        }
        _this3.model.setData('seriesResult', _this3.model.seriesResult);
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return this.api.sys_transfer({
                  ...
                  params: JSON.stringify({ "seriesInstanceUID": ssId })
    ...
    value: function cornerstoneContorlOther() {
      ...
      this.cornerstoneContorl.event._addEvent('ctcornerstone.loadImage', function (value) {
        _this4.getimage(value);
      });
      this.cornerstoneContorl.event._addEvent('ctcornerstone.addNode', function (value) {
        console.log(value, _this4.model.seriesInfo[value.sId]);
        var postData = {};
        postData.seriesAnnotationResultId = _this4.model.seriesInfo[value.sId].sarId; // that.model.seriesResult.data.id //.info.data.seriesInstanceUID
        postData.imageAnnotationId = value.toolType.imageAnnotationId;
        postData.imageAnnotationToolId = value.toolType.id;
        postData.result = _this4.model.makeJsonToBackend(value.path);
        //console.log(postData.result)
        _this4.api.image_result_create(postData).done(function (res) {
          _this4.app.loading.hide();
          value.backId = res.data.id;
          _this4.cornerstoneContorl.updataSequencelist(value);
        });
      });
      ...
      this.cornerstoneContorl.event._addEvent('ctcornerstone.editNode', function (value) {
        ...
        _this4.api.image_result_update(postData).done(function (res) {
          _this4.app.loading.hide();
        });
      });
      this.cornerstoneContorl.event._addEvent('ctcornerstone.deleteNode', function (value) {
        _this4.app.loading.show();
        _this4.api.image_result_delete({
          id: value.backId
        }).done(function (res) {
          _this4.app.loading.hide();
        });
    ...
    value: function btnEvent() {
      ...
      var page = this.app.parpam['projectType'] == 1 ? 'createprothree' : 'createbackflowpro3';
      this.dom.find('.back-icon').on('click', function () {
        window.location.href = 'http://' + window.location.host + '/#!/' + page + '/' + _this5.app.parpam['taskId'] + '/' + _this5.app.parpam['projectId'] + '/' + _this5.app.parpam['status'] + '/' + _this5.app.parpam['taskType'];
        window.location.reload();
      });
    ...
    value: function submitSeries(id, pading) {
      ...
      this.api.series_result_read({
        ...
        console.log(value, 'valuevaluevaluevalue', value.data.yayAttributes, _this6.model.projectInfo);
        if (_this6.model.projectInfo.yayAttributes == value.data.yayAttributes) {
          _this6.startSubmit();
          return false;
        }
        _this6.app.loading.hide();
        var data = value.data;
        var conmponentInfo = _this6.cornerstoneContorl.model.nidusComponentInfo;
        //判断大征象是否完成了
        var allnid = _this6.allnidussubmit(data);
        if (!allnid) {
          return true;
        }
          ...
          if (item.annotationItemResultList == null && optionLength != 0) {
            for (var w in conmponentInfo[item.imageAnnotationType]) {
              if (conmponentInfo[item.imageAnnotationType][w].optional) {
                _this6.errorShow(item, conmponentInfo[item.imageAnnotationType][w]);
                pading = true;
                return true;
              }
            }
          ...
          if (item.annotationItemResultList) {
            ...
            if (optionLength) {
              ...
              for (var _w in conmponentInfo[item.imageAnnotationType]) {
                if (idsAll.lastIndexOf(',' + _w + ',') == -1 && conmponentInfo[item.imageAnnotationType][_w].optional) {
                  _this6.errorShow(item, conmponentInfo[item.imageAnnotationType][_w]);
                  pading = true;
                  return true;
                }
              }
            ...
            for (var _j = 0; _j < item.annotationItemResultList.length; _j++) {
              ...
              if (!_res.result && conmponentInfo[item.imageAnnotationType][_res.annotationItemId].optional) {
                pading = true;
                _this6.errorShow(item, conmponentInfo[item.imageAnnotationType][_res.annotationItemId]);
                return true;
              }
            }
          }
      ...
      var _loop = function _loop(i) {
        if (i != 'annotationItemResultList') {
          ...
          if (allitem.optional) {
            ...
            if (!nowS) {
              _this7.alerError('“序列整体标注信息”的“' + allitem.componentName + '”为必填项，请填写完整。');
              return {
                v: false
              };
            }
    ...
    value: function series_submit() {
      ...
      this.api.series_result_submit({
        ...
        console.log(_this8.model.doneNum);
        //return
        if (_this8.model.doneNum == -1) {
          window.location.href = 'http://' + window.location.host + '/#!/personalaccount';
          window.location.reload();
...
module.exports = "<div class=drapCanvasView> <ul class=mark-header> <li class=\"back-icon fl\"> <span><span class=lefta><i class=\"iconfont icon-icon-test3\" style=font-size:12px></i></span><span class=infojian>医生主页</span></span> </li> <li class=\"task-name fl\"> <span>|</span> <span>Cassiel0705标注4</span> </li> <li class=\"cotrol-btn fr\"> </li> </ul> <div class=mark-menu></div> <div class=mark-content> </div> </div>";
...
//# sourceMappingURL=097217ad9053104bc340.14.min.js.map