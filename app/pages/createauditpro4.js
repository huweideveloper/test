class createprofour extends Interstellar.pagesBase {
  complete() {
    let that = this
  ...
  setTitle() {
    ...
    obj["icon"] = {
      ...
      name: {
        name: '<span data-i18n="age" data-name="年龄">审核任务名称</span>',
        type: "text",
        code: "checkid",
        w: "20%",
        ww: "20%"
      ...
      auditChoose: {
        name: '<span data-i18n="age" data-name="年龄">审核集</span>',
        type: "text",
        code: "pid",
        w: "18%",
        ww: "18%"
      ...
      seriesTotalNum: {
        name: '<span data-i18n="age" data-name="年龄">序列总数</span>',
        type: "text",
        code: "psex",
        w: "17%",
        ww: "17%"
      ...
      seriesAuditNum: {
        name: '<span data-i18n="age" data-name="年龄">已审核数</span>',
        type: "text",
        code: "psex",
        w: "17%",
        ww: "17%"
  ...
  async setMain(bool) {
    ...
    let res = await this.api.auditProjectTaskList({
      page: 1,
    ...
    if (res.code == 0) {
      ...
      if (tempList.length > 0) {
        ...
        tempList.forEach((val, idx) => {
          ...
          val.vendors = ""
          if (val.venderNameList && val.venderNameList.length) {
        ...
        this.table.setData(tempList, data2)
      } else {
        this.table.noData()
