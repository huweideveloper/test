  ...
  anno_iar_read: function(value) {
    ...
    ES.ajax({
      ...
      function(response) {
        ...
        // 2test...
        // response.data.imageList.forEach(v => {
        //   v.urlWan = v.urlWan.replace('http://proximatest.cn-sh2.ufileos.com', 'http://proximatest.internal-cn-sh2-01.ufileos.com')
        // })
